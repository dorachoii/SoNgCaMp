...
public struct UserInfo
{
    ...
    public UserInfo(string userEmail, string userPwd, string userNickname, int sessionType, int genre, int mood, bool musician)
    {
...
public class HttpManager : MonoBehaviour
{
    ...
    public UserInfo Resister(string id, string pw, string nickname, int sessionType, int genre, int mood, bool musician)
    {
        UserInfo userInfo = new UserInfo(id, pw, nickname, sessionType, genre, mood, musician);
        return (userInfo);
    }
